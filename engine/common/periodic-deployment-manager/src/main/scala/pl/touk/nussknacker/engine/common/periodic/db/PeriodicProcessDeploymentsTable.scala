...
import pl.touk.nussknacker.engine.common.periodic.model.{PeriodicProcessDeploymentId, PeriodicProcessDeploymentStatus, PeriodicProcessId}
...
trait PeriodicProcessDeploymentsTableFactory extends PeriodicProcessesTableFactory {
  ...
  private implicit val periodicProcessIdMapping: BaseColumnType[PeriodicProcessId] =
