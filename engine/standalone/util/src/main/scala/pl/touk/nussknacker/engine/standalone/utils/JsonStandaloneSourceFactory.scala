...
import pl.touk.nussknacker.engine.standalone.api.{DecodingError, StandalonePostFactory, StandaloneSourceFactory}

import scala.reflect.ClassTag

class JsonStandaloneSourceFactory[T:DecodeJson:ClassTag] extends StandalonePostFactory[T] {
