...
import pl.touk.nussknacker.ui.security.AuthenticatorFactory.{AuthenticatorData, LoggedUserAuth}
import pl.touk.nussknacker.ui.security.{AuthenticatorFactory, DefaultAuthenticationConfiguration}
