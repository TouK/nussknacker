...
import pl.touk.nussknacker.ui.security.oauth2.OAuth2ClientApi.ContentType
import pl.touk.nussknacker.ui.security.oauth2.OAuth2ClientApi.ContentType.ContentType
...
(configuration: OAuth2Configuration, contentType: ContentType = ContentType.APPLICATION_JSON)
