...
trait FlinkContextInitializer[Raw] extends ContextInitializer[Raw] {

  override type InitContextImplT = MapFunction[Raw, Context]

  def initContext(processId: String, nodeId: String): MapFunction[Raw, Context]
