...
/**
  ...
  */
trait BaseFlinkSource[T] extends Source[T] {

  def startStream(env: StreamExecutionEnvironment, metaData: MetaData): DataStream[T]
...
/**
  ...
  * @tparam T - type of event that is generated by this source. This is needed to handle e.g. syntax suggestions in UI
  */
trait FlinkSource[T] extends BaseFlinkSource[T] {
  ...
  override def startStream(env: StreamExecutionEnvironment, metaData: MetaData): DataStream[T] = {
