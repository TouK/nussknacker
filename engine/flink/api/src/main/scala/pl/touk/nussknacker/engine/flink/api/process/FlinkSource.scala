...
trait FlinkIntermediateRawSource[T] {
...
/**
  * Support for test mechanism for flink sources.
  * @tparam T - type of event that is generated by this source. This is needed to handle e.g. syntax suggestions in UI
  */
...
/**
  * Support for Context initialization. By default initContext maps raw source event to "input" variable in Context.
  * @tparam T - type of event that is generated by this source. This is needed to handle e.g. syntax suggestions in UI
  */
trait SourceContextTransformation[T] { self: Source[T] =>

  def initContext(processId: String, taskName: String): InitContextFunction[T] = new InitContextFunction[T](processId, taskName)
...
/**
  ...
  * @tparam T - type of event that is generated by this source. This is needed to handle e.g. syntax suggestions in UI
  */
trait BasicFlinkSource[T] extends FlinkSource[T] with FlinkIntermediateRawSource[T] with ExplicitUidInOperatorsSupport with SourceContextTransformation[T] {
