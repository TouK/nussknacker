      ...
      val flinkLibTweakCommand = ScalaMajorVersionConfig.scalaMajorVersion match {
        ...
        case "2.13" =>
          ...
          s"""
            ...
            |RUN wget https://oss.sonatype.org/content/repositories/snapshots/pl/touk/flink-scala-2-13_2.13/1.0.0-SNAPSHOT/flink-scala-2-13_2.13-1.0.0-SNAPSHOT-assembly.jar -O $$FLINK_HOME/lib/flink-scala-2-13_2.13-1.0.0-SNAPSHOT-assembly.jar
            |RUN chown flink $$FLINK_HOME/lib/flink-scala-2-13_2.13-1.0.0-SNAPSHOT-assembly.jar
