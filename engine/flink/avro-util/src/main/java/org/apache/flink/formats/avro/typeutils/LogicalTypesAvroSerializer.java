 ...
 */
public class LogicalTypesAvroSerializer<T> extends TypeSerializer<T> {
	...
	public LogicalTypesAvroSerializer(Class<T> type, Schema schema) {
		this(checkNotNull(type), new NkSerializableAvroSchema(checkNotNull(schema)), new NkSerializableAvroSchema());
		checkArgument(isGenericRecord(type),
	 ...
	 */
	@Internal
	LogicalTypesAvroSerializer(Class<T> type, NkSerializableAvroSchema newSchema, NkSerializableAvroSchema previousSchema) {
	...
	/**
	 * @deprecated Use {@link LogicalTypesAvroSerializer#LogicalTypesAvroSerializer(Class)} instead.
	 */
	@Deprecated
	@SuppressWarnings("unused")
	public LogicalTypesAvroSerializer(Class<T> type, Class<? extends T> typeToInstantiate) {
		this(type);
	}
	...
	public TypeSerializerSnapshot<T> snapshotConfiguration() {
		if (configSnapshot == null) {
			checkAvroInitialized();
			configSnapshot = new LogicalTypesAvroSerializerSnapshot<>(runtimeSchema, type);
		}
	...
	public TypeSerializer<T> duplicate() {
		checkAvroInitialized();
		return new LogicalTypesAvroSerializer<>(type, new NkSerializableAvroSchema(runtimeSchema), previousSchema);
	}
	...
	public boolean equals(Object obj) {
		...
		else if (obj != null && obj.getClass() == LogicalTypesAvroSerializer.class) {
			final LogicalTypesAvroSerializer that = (LogicalTypesAvroSerializer) obj;
	 ...
	 */
	@Deprecated
	public static final class LogicalTypesAvroSchemaSerializerConfigSnapshot<T> extends LogicalTypesAvroSerializerSnapshot<T> {
