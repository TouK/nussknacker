...
/**
  ...
  * @tparam T
  */
class ConfluentKafkaAvroDeserializer[T](topic: String, version: Option[Int], schemaRegistry: ConfluentSchemaRegistryClient, isKey: Boolean)
  ...
  override def deserialize(topic: String, data: Array[Byte]): T = {
    ...
    val schema = schemaRegistry.getFreshSchema(subject, version)
