...
public class GeneratedAvroClassWithLogicalTypes extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2866638248073144390L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"GeneratedAvroClassWithLogicalTypes\",\"namespace\":\"pl.touk.nussknacker.engine.avro.schema\",\"fields\":[{\"name\":\"dateTime\",\"type\":[\"null\",{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}],\"default\":null},{\"name\":\"date\",\"type\":[\"null\",{\"type\":\"int\",\"logicalType\":\"date\"}],\"default\":null},{\"name\":\"time\",\"type\":[\"null\",{\"type\":\"int\",\"logicalType\":\"time-millis\"}],\"default\":null},{\"name\":\"decimal\",\"type\":[\"null\",{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":4,\"scale\":2}],\"default\":null}]}");
...
static {
   ...
   */
  public GeneratedAvroClassWithLogicalTypes(java.time.Instant dateTime, java.time.LocalDate date, java.time.LocalTime time, java.math.BigDecimal decimal) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: dateTime = (java.time.Instant)value$; break;
    case 1: date = (java.time.LocalDate)value$; break;
    case 2: time = (java.time.LocalTime)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GeneratedAvroClassWithLogicalTypes>
    ...
    public GeneratedAvroClassWithLogicalTypes build() {
      try {
        ...
        record.dateTime = fieldSetFlags()[0] ? this.dateTime : (java.time.Instant) defaultValue(fields()[0]);
        record.date = fieldSetFlags()[1] ? this.date : (java.time.LocalDate) defaultValue(fields()[1]);
        record.time = fieldSetFlags()[2] ? this.time : (java.time.LocalTime) defaultValue(fields()[2]);
