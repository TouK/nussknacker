...
object KafkaProducerHelper {
  ...
  def createRecord(topic: String, key: Array[Byte], value: Array[Byte], timestamp: lang.Long, headers: Headers = KafkaRecordHelper.emptyHeaders): ProducerRecord[Array[Byte], Array[Byte]] = {
