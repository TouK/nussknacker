...
object sinks {
  ...
  class GenericKafkaJsonFlinkSink(processObjectDependencies: ProcessObjectDependencies)
    extends KafkaFlinkSinkFactory(GenericJsonSerialization, processObjectDependencies)
