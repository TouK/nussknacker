...
class KafkaExceptionConsumerSerializationSpec extends FunSuite with Matchers {
  ...
  private val exception = NuExceptionInfo(Some(ExceptionComponentInfo("nodeId", "componentName", "componentType")), NonTransientException("input1", "mess", Instant.ofEpochMilli(111)), Context("ctxId"))
