...
import pl.touk.nussknacker.engine.api.{NodeId, ScenarioProcessingContext => NkContext, _}
...
object transformers {
  ...
  def slidingTransformer(
    ...
    ContextTransformation
      ...
      .implementedBy(FlinkCustomStreamTransformation((start: DataStream[NkContext], ctx: FlinkCustomNodeContext) => {
