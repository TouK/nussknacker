...
import pl.touk.nussknacker.engine.flink.table.SpelValues
import pl.touk.nussknacker.engine.flink.table.batch.TableJoinTest.OrderOrProduct
...
class TableJoinTest
  ...
  import pl.touk.nussknacker.engine.flink.table.batch.TableJoinTest.OrderOrProduct.RowExtension
  import pl.touk.nussknacker.engine.flink.util.test.FlinkTestScenarioRunner._
  import pl.touk.nussknacker.engine.spel.SpelExtension._

  import scala.jdk.CollectionConverters._

  private lazy val additionalComponents: List[ComponentDefinition] = FlinkTableOpsBatchComponentProvider.components
