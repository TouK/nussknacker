package pl.touk.nussknacker.engine.flink.table.batch.aggregate
...
import pl.touk.nussknacker.engine.flink.table.batch.aggregate.TableAggregationFactory.aggregateByParamName
import pl.touk.nussknacker.engine.flink.table.typing.simulateddatatype.{SimulatedCallContext, ToSimulatedDataTypeConverter}
