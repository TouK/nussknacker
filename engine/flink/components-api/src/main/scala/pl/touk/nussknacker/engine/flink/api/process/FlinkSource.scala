...
/**
  ...
  * If the source returns a record having generic type and its fields and methods cannot be discovered using reflection,
  * [[pl.touk.nussknacker.engine.api.typed.ReturningType]] can be implemented to provide detailed typing info for the emitted `#input`.
  *
  * @tparam Raw - type of raw event that is generated by flink source function.
  *             This is needed to handle e.g. syntax suggestions in UI (in sources with explicite @MethodToInvoke).
  */
