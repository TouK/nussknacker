...
class FlinkTestMainSpec extends FunSuite with Matchers with Inside with BeforeAndAfterEach {
  ...
  test("be able to return test results") {
    ...
    val results = runFlinkTest(process, TestData(List("0|1|2|3|4|5|6", "0|11|2|3|4|5|6").mkString("\n")))
  ...
  test("handle large parallelism") {
    ...
    val results = runFlinkTest(process, TestData(List("0|1|2|3|4|5|6", "0|11|2|3|4|5|6", "0|11|2|3|4|5|6", "0|11|2|3|4|5|6", "0|11|2|3|4|5|6").mkString("\n")))
  ...
  test("detect errors") {
    ...
    val results = runFlinkTest(process, TestData(List("0|1|2|3|4|5|6", "1|0|2|3|4|5|6", "2|2|2|3|4|5|6", "3|4|2|3|4|5|6").mkString("\n")))
  ...
  test("handle transient errors") {
    ...
    val run = Future {
      runFlinkTest(process, TestData(List("2|2|2|3|4|5|6").mkString("\n")))
    }
  ...
  test("give meaningful error messages for sink errors") {
    ...
    val run = Future {
      runFlinkTest(process, TestData("2|2|2|3|4|5|6"))
    }
  ...
  test("be able to test typed map") {
    ...
    val results = runFlinkTest(process, TestData("""{"field1": "abc", "field2": "def"}"""))
  ...
  test("using dependent services") {
    ...
    val results = runFlinkTest(process, TestData(s"0|$valueToReturn|2|3|4|5|6"))
  ...
  test("switch value should be equal to variable value") {
    ...
    val results = runFlinkTest(process, TestData(List(recordTrue, recordFalse).mkString("\n")))
  ...
  test("should handle joins for one input (diamond-like) ") {
    ...
    val results = runFlinkTest(process, TestData(List(recA, recB, recC).mkString("\n")))
