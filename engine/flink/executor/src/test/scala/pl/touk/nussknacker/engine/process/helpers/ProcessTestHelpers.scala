...
object ProcessTestHelpers extends Serializable {
  ...
  def prepareComponents(data: List[SimpleRecord]): List[ComponentDefinition] = List(
    ...
    ComponentDefinition("multiOutputSplitOddEven", MultiOutputSplitOddEven),
    ComponentDefinition("multiOutputMissingOutputStream", MultiOutputMissingOutputStream),
    ComponentDefinition("multiOutputWithSingleOutputTransformation", MultiOutputWithSingleOutputTransformation),
    ComponentDefinition("multiOutputWrongMainOutputKey", MultiOutputWrongMainOutputKey),
    ComponentDefinition("multiOutputDuplicatedKey", MultiOutputDuplicatedKey),
    ComponentDefinition("singleOutputNamedMainOutput", SingleOutputNamedMainOutput),
