...
class VerificationFlinkProcessCompiler(process: CanonicalProcess,
  ...
  override protected def prepareService(service: DefinitionExtractor.ObjectWithMethodDef,
                                        context: ComponentDefinitionContext): DefinitionExtractor.ObjectWithMethodDef =
  ...
  override protected def prepareSourceFactory(sourceFactory: DefinitionExtractor.ObjectWithMethodDef,
                                              context: ComponentDefinitionContext): DefinitionExtractor.ObjectWithMethodDef =
