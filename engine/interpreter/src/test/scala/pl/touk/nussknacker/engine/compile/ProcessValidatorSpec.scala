...
class ProcessValidatorSpec extends FunSuite with Matchers with Inside {
  ...
  private val baseDefinition = ProcessDefinition[ObjectDefinition](
    ...
    ExpressionDefinition(
      ...
      List.empty, List.empty, LanguageConfiguration.default, optimizeCompilation = false, strictTypeChecking = true, dictionaries = Map.empty, hideMetaVariable = false, strictMethodsChecking = true, referenceTypeValidating = true
    ),
