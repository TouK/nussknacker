  ...
  def validate(nodeData: NodeData, modelData: ModelData,
    ...
    modelData.withThisAsContextClassLoader {
      ...
      nodeData match {
        ...
        case a: Variable => toValidationResponse(compiler.compileExpression(a.value, validationContext, expectedType = typing.Unknown, outputVar = Some(OutputVar(a.varName))))
        case a: VariableBuilder => toValidationResponse(compiler.compileFields(a.fields, validationContext, outputVar = Some(OutputVar(a.varName))))
