...
class DatabaseEnricherRuntimeLogicWithCache(
...
) extends DatabaseEnricherRuntimeLogic(
      query,
      argsCount,
      tableDef,
      strategy,
  ...
  import DatabaseEnricherRuntimeLogicWithCache._
