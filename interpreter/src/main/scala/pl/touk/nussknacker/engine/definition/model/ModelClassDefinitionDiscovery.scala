...
import pl.touk.nussknacker.engine.definition.component.{ComponentClassDefinitionDiscovery, ComponentDefinitionWithLogic}
...
object ModelClassDefinitionDiscovery {
  ...
  def discoverClasses(definition: ModelDefinition[ComponentDefinitionWithLogic]): Set[ClassDefinition] = {
