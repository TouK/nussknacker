...
class DynamicComponentLogic(obj: GenericNodeTransformation[_]) extends ComponentLogic {
  ...
  override def run(
    ...
    obj.runLogic(params, additionalParams, finalStateValue.asInstanceOf[Option[obj.State]])
  }
