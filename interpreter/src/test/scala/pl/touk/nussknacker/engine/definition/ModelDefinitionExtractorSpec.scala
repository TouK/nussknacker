...
import pl.touk.nussknacker.engine.definition.component.implinvoker.MethodBasedComponentImplementationInvoker
...
class ModelDefinitionExtractorSpec extends AnyFunSuite with Matchers with OptionValues {
