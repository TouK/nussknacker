...
object validationHelpers {
  ...
  object SimpleStringSource extends SourceFactory with StreamingComponent {
  ...
  class GenericParametersSource extends SourceFactory with GenericParameters[Source] with StreamingComponent {
  ...
  class GenericParametersSourceNoTestSupport extends GenericParametersSource with StreamingComponent {
  ...
  class GenericParametersSourceNoGenerate extends GenericParametersSource with StreamingComponent {
  ...
  class SourceWithTestParameters extends GenericParametersSource with StreamingComponent {
