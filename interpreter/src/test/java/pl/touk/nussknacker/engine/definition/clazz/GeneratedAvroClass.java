...
public class GeneratedAvroClass extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"GeneratedAvroClass\",\"namespace\":\"pl.touk.nussknacker.engine.definition.clazz.GeneratedAvroClass\",\"fields\":[{\"name\":\"text\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
     ...
     */
    public static GeneratedAvroClass.Builder newBuilder() {
        return new GeneratedAvroClass.Builder();
    }
     ...
     * @return A new GeneratedAvroClass RecordBuilder
     */
    public static GeneratedAvroClass.Builder newBuilder(GeneratedAvroClass.Builder other) {
        return new GeneratedAvroClass.Builder(other);
    }
     ...
     * @return A new GeneratedAvroClass RecordBuilder
     */
    public static GeneratedAvroClass.Builder newBuilder(GeneratedAvroClass other) {
        return new GeneratedAvroClass.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GeneratedAvroClass>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(GeneratedAvroClass.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(GeneratedAvroClass other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.text)) {
                this.text = data().deepCopy(fields()[0].schema(), other.text);
                fieldSetFlags()[0] = true;
         ...
         * @return This builder.
         */
        public GeneratedAvroClass.Builder setText(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public GeneratedAvroClass.Builder clearText() {
            text = null;
