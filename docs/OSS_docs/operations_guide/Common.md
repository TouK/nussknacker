...
Some of them are external, but it also helps to read about important Nussknacker concepts in [glossary](/docs/about/GLOSSARY.md) and [scenario authoring](/docs/scenariosAuthoring/introduction.mdx).
