...
Please make sure you know common [Glossary](/docs/about/GLOSSARY.md) and [SpEL](/docs/scenariosAuthoring/SpEL.md) (especially the Data types section) before proceeding further. 
...
- Customizations of model (in particular `ComponentProviders`) can be loaded by adding libs/classes to dedicated `components/common/extra`, 
  ...
  in [Model config](/docs/configuration/model/ModelConfiguration.md).
...
[Components](/docs/about/GLOSSARY.md#component) are main method of customizing Nussknacker. Components are created by configured `ComponentProvider` instances. 
...
To read more see [ComponentProvider API](/docs/OSS_docs/developers_guide/Components.md)
...
[Scenario Deployment Configuration page](/docs/OSS_docs/configuration/ScenarioDeploymentConfiguration.md) 
