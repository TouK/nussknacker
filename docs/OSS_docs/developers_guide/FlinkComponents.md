...
- [Timestamp watermark handler](https://github.com/TouK/nussknacker/blob/staging/engine/flink/components-api/src/main/scala/pl/touk/nussknacker/engine/flink/api/timestampwatermark/TimestampWatermarkHandler.scala)
  ...
  [notion of time](/docs/scenariosAuthoring/streamingProcessingMode.md#notion-of-time)
...
Read more about testing functionality in [this section](/docs/scenariosAuthoring/testingAndDebugging.mdx).
...
### Examples
- [Event generator source](/docs/components/eventGenerator.mdx) and its [implementation](https://github.com/TouK/nussknacker/blob/staging/engine/flink/components/base/src/main/scala/pl/touk/nussknacker/engine/flink/util/transformer/EventGeneratorSourceFactory.scala)
...
Great examples of custom transformers are [aggregates in time windows](/docs/components/index.mdx#). [See here](https://github.com/TouK/nussknacker/tree/staging/engine/flink/components/base/src/main/scala/pl/touk/nussknacker/engine/flink/util/transformer) how components like [previousValue](/docs/components/previousValue.mdx), [delay](/docs/components/delay.mdx)
