...
| HTTP_PUBLIC_PATH              | string  |                                                        | Public HTTP path prefix the Designer UI is served at, e.g. using external proxy like [nginx](/docs/OSS_docs/installation/Binaries.md#configuring-the-designer-with-nginx-http-public-path)                                                          |
| DB_URL                        | string  | jdbc:hsqldb:file:${STORAGE_DIR}/db;sql.syntax_ora=true | [See also](/docs/OSS_docs/configuration/DesignerConfiguration.md#database-configuration) for more information                                                                                                                                                         |
...
| SCHEMA_REGISTRY_CACHE_TTL     | string  | 10 seconds                                             | Cache TimeToLeave for fetched schemas                                                                                                                                                                                                                     |
