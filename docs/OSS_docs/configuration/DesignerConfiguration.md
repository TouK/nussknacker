...
Designer configuration area contains configs for web application interface, security, various UI settings, database and more. Check [configuration areas](/docs/OSS_docs/configuration/Overview.mdx) to understand where Designer configuration should be
