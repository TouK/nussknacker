...
###Configuration process toolbars on front-end

```
defaultProcessToolbars {
  topLeft: [
    { id: "tips" }
    { id: "creator" }
    { id: "versions" }
  ...
  topRight: [
    {
      ...
      buttons: [
        ...
        { type: "process-action-deploy" }
        { type: "process-action-cancel" }
    ...
    }
    {
      ...
      buttons: [
        ...
        { type: "process-json" }
        { type: "process-pdf" }
        { type: "process-action-archive" }
        { type: "process-action-unarchive" }
      ]
    }
    {
      id: "test"
