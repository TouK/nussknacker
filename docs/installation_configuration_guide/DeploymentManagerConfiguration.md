...
| request-response.definitionMetadata.servers               | string          |               | (Optional) Configuration of exposed servers in scenario's OpenApi definition. When not configured, will be used server with ./ relative url | 
