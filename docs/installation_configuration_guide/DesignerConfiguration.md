...
Designer configuration area contains configs for web application interface, security, various UI settings, database and more. Check [configuration areas](./Common.mdx#configuration-areas) to understand where Designer configuration should be
