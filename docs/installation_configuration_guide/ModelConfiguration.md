...
| componentsAction                                   | Low        | map      | Map("usages" -> {...}  | Component's actions configuration which are displayed at list of components. Type: `Map[String, {tile: String, icon: String, url: Option[String], type: []} }`                |
