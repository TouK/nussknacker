...
| schemaRegistryCacheConfig.availableSchemasExpirationTime                      | Low        | duration         | 1 minute         | How often available schemas cache will be invalidated. This determine how long you will wait after adding new schema or new schema version until it will be available in Designer                                                                            |
