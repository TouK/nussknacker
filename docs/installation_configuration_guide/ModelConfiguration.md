...
| lowLevelComponentsEnabled                                                   | Medium     | boolean  | false            | Add low level kafka components: 'kafka-json', 'kafka-avro', 'kafka-registry-typed-json'                                                                                                                                                                      |
| avroAsJsonSerialization                                                     | Low        | boolean  | false            | Send payload on avro schema topic as plaintext json                                                                                                                                                                                                          |
