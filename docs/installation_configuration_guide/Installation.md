...
| STORAGE_DIR                   | string          | $WORKING_DIR/storage                           Ľ                                                                             | Location of HSQLDB database storage                                                                                                                                                                                                                                                                        |
| MANAGERS_DIR                  | string          | $WORKING_DIR/managers                                                                                                        | Location of deployment manager providers                                                                                                                                                                                                                                                                   |
| LIB_DIR                       | string          | $WORKING_DIR/lib                                                                                                             | Location of Nu related jar libraries e.g. database driver                                                                                                                                                                                                                                                  |
| CLASSPATH                     | string          | $LIB_DIR/*:$MANAGERS_DIR/*                                                                                                   | Classpath of the designer                                                                                                                                                                                                                                                                                  |
...
| KAFKA_AUTO_OFFSET_RESET       | string          |                                                                                                                              | See [Kafka documentation](https://kafka.apache.org/documentation/#consumerconfigs_auto.offset.reset). For development purposes it may be convenient to set this value to 'earliest', when not set default from Kafka ('latest' at the moment) is used.                                                     |
...
| PROMETHEUS_AGENT_CONFIG_FILE  | int             | $NUSSKNACKER_DIR/conf/jmx_prometheus.yaml                                                                                    | Default configuration for JMX Prometheus agent. Used only when agent enabled. See `PROMETHEUS_METRICS_PORT`                                                                                                                                                                                                |
