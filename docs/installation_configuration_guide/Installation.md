...
| CLASSPATH                     | string          | $NUSSKNACKER_DIR/lib/*:$NUSSKNACKER_DIR/managers/*                                                                           | Classpath of the designer, lib directory cotains related jar libraries e.g. database driver, managers directory contains deployment manager providers                                                                                                                                                      |
