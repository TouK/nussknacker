...
| MODEL_CLASS_PATH                | list of strings | `["model/defaultModel.jar", "components/flink/base.jar", "components/flink/kafka.jar"]` | Classpath of model (jars that will be used for execution of scenarios)                                                                                                |
