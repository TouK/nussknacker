...
Based on your network topology after you deploy a `Request-response` scenario there should be either a k8s service or ingress allowing you to connect to scenario.
...
After you deploy your `Request-Response` scenario there will be available OpenAPI definition based on input and output schema you have provided in scenario properties.
