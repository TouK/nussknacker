...
After you deploy your `Request-Response` scenario an OpenAPI document (definition of the OpenAPI service) will be available at `http://<scenario_name>/definition`
