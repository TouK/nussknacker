...
| idlenessConfig.enableIdleTimeout                  | Medium     | boolean                    | true               | Enabling [idleness](https://nightlies.apache.org/flink/flink-docs-stable/docs/connectors/datastream/kafka/#idleness) used by Kafka sources                                                                      |
| idlenessConfig.idleTimeoutDuration                | Medium     | long                       | 3 minutes          | Configuration of [idle timout](https://nightlies.apache.org/flink/flink-docs-stable/docs/connectors/datastream/kafka/#idleness) used by Kafka sources                                                           |
