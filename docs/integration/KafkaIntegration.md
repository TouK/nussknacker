...
| kafkaAdminConfig.cacheConfig.autoCreateTopicFlagExpirationTime | Low        | duration | 5 minutes     | How long fetched `auto.create.topics.enable` setting will be cached                                                                                                                                                                                                                                                                      |
### Exception handling
