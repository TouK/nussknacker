...
| topicsWithoutSchemaConfig.showTopicsWithoutSchema                           | Low        | boolean  | true          | Determine if all Kafka topics should be displayed or only topics with matching schema on schema registry                                                                                                                                                                                                                                 |
| topicsWithoutSchemaConfig.topicsFetchTimeout                                | Low        | duration | 10 seconds    | Timeout for fetching topics from Kafka cluster                                                                                                                                                                                                                                                                                           |
| topicsWithoutSchemaConfig.topicsFetchCacheTtl                               | Low        | duration | 30 seconds    | TTL for caching list of existing topics                                                                                                                                                                                                                                                                                                  |
