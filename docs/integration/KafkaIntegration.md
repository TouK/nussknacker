...
| kafkaEspProperties.defaultOffsetResetStrategy                               | Medium     | boolean  | None          | If scenario is restarted, should offsets of source consumers be reset to latest (can be useful in test environments) or earliest, or consumers continue reading where previously stopped.                                                                                                                                                |
