...
In the Designer the user can choose, for each source and sink, which schema version should be used for syntax [suggestions and validation](/docs/scenarios_authoring/HandlingSchemas.md).
