...
* [#3674](https://github.com/TouK/nussknacker/pull/3674) Fix: validate multiple same fragments used in a row in legacy scenario jsons (without `outputVariableNames` field in `SubprocessRef`)
