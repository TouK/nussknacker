...
* [#6225](https://github.com/TouK/nussknacker/pull/6225) Resolved an issue with input parameters where the initial value was defined and the input mode changed from any value to a fixed list.
