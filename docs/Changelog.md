...
* [#7665](https://github.com/TouK/nussknacker/pull/7665) Extract `StaticParameterEditor` as a set of editors for
  scenario properties and action parameters that handle only static values. 
