...
* [#7468](https://github.com/TouK/nussknacker/pull/7468) Configurable namespace separator (was fixed to `_`)
  and possibility to override namespaces for each context (`kafkaTopic`, `flink`, `metrics`)
