...
* [#5141](https://github.com/TouK/nussknacker/pull/5141) Security improvement: API endpoints check if user has access to category associated with processing type provided in API
