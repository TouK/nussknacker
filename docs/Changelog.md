...
* [#5266](https://github.com/TouK/nussknacker/pull/5266) Security improvement: fixed order of accessing no-parameter methods and keys in 
  records in expressions where the method of the same name or with the name as the accessed key with getter prefix would be returned instead 
  of value associated with the key.
  Examples:
