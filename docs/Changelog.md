...
* [#9472](https://github.com/TouK/nussknacker/pull/9472) Fix scenarios failing on a null `aggregateBy`, and return `null` from a numeric aggregate that aggregated nothing, in place of `0` or `Double.NaN`. See the [Migration Guide](MigrationGuide.md) for details.
