...
* [#7483](https://github.com/TouK/nussknacker/pull/7483) Its possible to configure kafka source to work without schema registry. To do that you should not provide property "schema.registry.url" in kafkaProperties config. 
