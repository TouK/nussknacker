...
* [#7453](https://github.com/TouK/nussknacker/pull/7453) Improved scenario loading time in the Designer GUI (optimized and rearranged API calls, improved GUI component loading order)  
