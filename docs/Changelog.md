...
* Batch processing mode related improvements:
  ...
  * [#6734](https://github.com/TouK/nussknacker/pull/6734) Available tables are now refreshed automatically when
    entering into node form. No restart is needed. This feature is useful when external catalog is used
