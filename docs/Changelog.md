...
* [#2540](https://github.com/TouK/nussknacker/pull/2540) It's possible to use different Effects than `Future` in standalone engine. `InvocationMetrics` are no longer 
