...
| miniCluster.reuseMiniClusterForScenarioTesting           | boolean        | true          | Creates mini cluster once and reuses it for each scenario testing attempt                                                                                                                                                                   |
| miniCluster.reuseMiniClusterForScenarioStateVerification | boolean        | true          | Creates mini cluster once and reuses it for each scenario state verification                                                                                                                                                                |
| miniCluster.config                                       | map of strings | [:]           | Configuration that will be passed to `MiniCluster`                                                                                                                                                                                          |
| miniCluster.streamExecutionEnvConfig                     | map of strings | [:]           | Configuration that will be passed to `StreamExecutionEnvironment` used along with  `MiniCluster`                                                                                                                                            |                                                                                                                                                               |
