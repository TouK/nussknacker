...
| miniCluster.useForScenarioTesting           | boolean        | true          | Creates mini cluster once and reuses it for each scenario testing attempt                                                                                                                                                                   |
| miniCluster.useForScenarioStateVerification | boolean        | true          | Creates mini cluster once and reuses it for each scenario state verification                                                                                                                                                                |
