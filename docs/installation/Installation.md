...
| DB_URL                        | string          | jdbc:hsqldb:file:${STORAGE_DIR}/db;sql.syntax_ora=true                                                                                        | Database; see [this page](../installation_configuration_guide/DesignerConfiguration.md#database-configuration) for more details                                                                                                                           |
