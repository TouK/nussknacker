...
| HTTP_PUBLIC_PATH              | string          |                                                                                                                              | Public HTTP path prefix the Designer UI is served at, e.g. using external proxy like [nginx](Installation#configuring-the-designer-with-nginx-http-public-path)                                                                                                                                              |
