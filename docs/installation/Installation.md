...
| TABLES_DEFINITION_FILE        | string          | $NUSSKNACKER_DIR/conf/tables-definition.sql                                                                                                   | Location of file containing definitions of tables for Flink Table API components in Flink Sql                                                                                                                                                             |
