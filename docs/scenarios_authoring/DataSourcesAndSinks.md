...
![sample_generator_window](img/event-generator.png)

This source generates events at a user-defined interval.

There are two primary use cases for this component:

- Generating a stream of data (typically for testing): The #input variable, available downstream, will be populated with the data generated by this component. Use the #RANDOM helper to produce random values.
