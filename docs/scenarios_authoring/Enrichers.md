...
Enricher components need to be added to the Model configuration first; once they are added they will become available in the Designer's components toolbox. Check [configuration areas](../configuration/index.mdx#configuration-areas) for the overview of the configuration and [configuration of extra components](https://docs.nussknacker.io/OSS_docs/integration/OpenAPI/) for details of how to configure enricher components.
