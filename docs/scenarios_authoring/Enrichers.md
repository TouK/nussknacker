...
- Decision Table: a user defined table of type TabularTypedData, discussed below.
- Match condition: a Boolean SpEL expression that matches input to table rows, discussed below.
- Output: name of the output variable which will hold data generated by the component.
