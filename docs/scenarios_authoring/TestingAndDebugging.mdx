...
sidebar_position: 8
---
import correctErrorUrl from '@site/static/quickstart/correctError.mp4';
...
Watch also this video to see debugging functionality in action.

<video width="100%" controls>
  <source src={correctErrorUrl} type="video/mp4"></source>
</video>
