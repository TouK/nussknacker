...
### Other changes
* [#3441](https://github.com/TouK/nussknacker/pull/3441)[#3618](https://github.com/TouK/nussknacker/pull/3618)  Updated Flink 1.14.5 -> 1.15.3. Some Flink artefacts no longer have Scala version. Test using Flink may need to disable checkpointing or reduce time between checkpoints to prevent timeouts or long waits for tasks to finish.
