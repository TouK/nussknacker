...
* [#3665](https://github.com/TouK/nussknacker/pull/3665) Cleanup kafka components:
  ...
  * `SpecificRecordKafkaAvroSourceFactory`, `GenericTypedJsonSourceFactory`, `DelayedGenericTypedJsonSourceFactory` were removed, we will no longer support those components.
