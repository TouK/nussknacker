...
* Component's API changes
  * [#6578](https://github.com/TouK/nussknacker/pull/6578) `SingleComponentConfig` changed to `ComponentConfig` for better domain naming. Associated functions and objects also changed to `...ComponentConfig...`.
