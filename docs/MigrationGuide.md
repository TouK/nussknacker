...
* [!485](https://gitlab.touk.pl/nussknacker1/nussknacker/-/merge_requests/485) **Behavior change:** duration parameters of several base components are now validated at scenario compile time.
