...
* [#1357](https://github.com/TouK/nussknacker/pull/1357) Run mode added to nodes.
  - `ServiceInvoker` interface extended with new, implicit `runMode` parameter. 
  - `FlinkProcessRegistrar` takes new parameter `runMode`.
