...
object LayoutData {
  implicit val schema: Schema[LayoutData] = Schema.derived[LayoutData]
}
...
object ProcessAdditionalFields {
  ...
  implicit val schema: Schema[ProcessAdditionalFields] = Schema.derived[ProcessAdditionalFields]
