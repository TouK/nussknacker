...
import { useCellArrowKeys } from "./usageCountCell";
...
export function CategoriesCell({ row, id, field, filterValue }: GridRenderCellParams & { filterValue: string[] }): JSX.Element {
