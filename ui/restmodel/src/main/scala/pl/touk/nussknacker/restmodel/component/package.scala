...
package object component {
  ...
  @JsonCodec
  final case class ComponentListElement(id: String, name: String, icon: String, componentType: ComponentType, componentGroupName: ComponentGroupName, categories: List[String])
