...
describe("ListState tests", () => {
  ...
  it("should show defaults for no loaded state", () => {
    const process = {"processingType":"streaming","lastAction":{"action":"DEPLOY"}}
  ...
  it("should show defaults for never deployed process", () => {
    const process = {"processingType":"streaming","lastAction": null}
  ...
  it("should show defaults for loaded canceled state", () => {
    const process = {"processingType":"streaming", "lastAction": {"action":"CANCELED"}}
