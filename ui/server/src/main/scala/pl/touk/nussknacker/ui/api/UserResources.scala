...
import pl.touk.nussknacker.ui.security.GlobalPermission.GlobalPermission
import pl.touk.nussknacker.ui.security.{AdminUser, CommonUser, GlobalPermission, LoggedUser, Permission}
