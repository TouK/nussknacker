...
case class ComponentLinkConfig(id: String, title: String, icon: String, url: String, supportedComponentTypes: Option[List[ComponentType]]) {
  ...
  def toComponentLink(componentId: ComponentId, componentName: String): ComponentLink = ComponentLink(
      ...
      NuIcon(URI.create(fillByComponentData(icon, componentId, componentName, urlOption = true))),
      NuLink(URI.create(fillByComponentData(url, componentId, componentName, urlOption = true)))
    )
}
...
object ComponentLinkConfig {
  ...
  def create(id: String, title: String, icon: String, url: String, supportedComponentTypes: Option[List[ComponentType]]): ComponentLinkConfig =
    ComponentLinkConfig(id, title, icon, url, supportedComponentTypes)
