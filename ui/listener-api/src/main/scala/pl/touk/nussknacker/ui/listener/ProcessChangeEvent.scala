...
object ProcessChangeEvent {
  ...
  final case class OnDeployActionSuccess(processId: ProcessId, version: VersionId, deploymentComment: Option[DeploymentComment], deployedAt: LocalDateTime, action: ProcessActionType) extends ProcessChangeEvent
