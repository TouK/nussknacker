...
object ProcessChangeEvent {
  ...
  final case class OnDeployActionSuccess(processId: ProcessId, version: VersionId, deploymentComment: Option[Comment], deployedAt: LocalDateTime, action: ProcessActionType) extends ProcessChangeEvent
