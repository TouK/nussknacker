...
trait AbstractSchemaRegistryBasedSerializerFactory {
  ...
  protected final def createSerializer(kafkaConfig: KafkaConfig,
                                       schemaDataOpt: Option[RuntimeSchemaData[ParsedSchema]],
                                       isKey: Boolean): Serializer[Any] = {
...
class KafkaSchemaRegistryBasedValueSerializationSchemaFactory(protected val schemaRegistryClientFactory: SchemaRegistryClientFactory,
                                                              protected val serializerFactory: SchemaRegistryBasedSerializerFactory)
  extends KafkaSchemaBasedValueSerializationSchemaFactory with AbstractSchemaRegistryBasedSerializerFactory {

  override protected[schemedkafka] def createValueSerializer(schemaOpt: Option[RuntimeSchemaData[ParsedSchema]], kafkaConfig: KafkaConfig): Serializer[Any] =
    createSerializer(kafkaConfig, schemaOpt, isKey = false)
}

class KafkaSchemaRegistryBasedKeyValueSerializationSchemaFactory(protected val schemaRegistryClientFactory: SchemaRegistryClientFactory,
                                                                 protected val serializerFactory: SchemaRegistryBasedSerializerFactory)
  extends KafkaSchemaBasedKeyValueSerializationSchemaFactory with AbstractSchemaRegistryBasedSerializerFactory {
