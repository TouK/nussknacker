 ...
 */
public class LogicalTypesGenericRecordBuilder extends RecordBuilderBase<Record> {
     ...
     */
    public LogicalTypesGenericRecordBuilder(LogicalTypesGenericRecordBuilder other) {
        super(other, AvroUtils.genericData());
     ...
     */
    public LogicalTypesGenericRecordBuilder(Record other) {
        super(other.getSchema(), AvroUtils.genericData());
     ...
     */
    public LogicalTypesGenericRecordBuilder set(String fieldName, Object value) {
     ...
     * @return a reference to the RecordBuilder.
     */
    public LogicalTypesGenericRecordBuilder set(Field field, Object value) {
     ...
     * @return a reference to the RecordBuilder.
     */
    protected LogicalTypesGenericRecordBuilder set(int pos, Object value) {
     ...
     * @return a reference to the RecordBuilder.
     */
    private LogicalTypesGenericRecordBuilder set(Field field, int pos, Object value) {
     ...
     * @return a reference to the RecordBuilder.
     */
    public LogicalTypesGenericRecordBuilder clear(String fieldName) {
     ...
     * @return a reference to the RecordBuilder.
     */
    public LogicalTypesGenericRecordBuilder clear(Field field) {
     ...
     * @return a reference to the RecordBuilder.
     */
    protected LogicalTypesGenericRecordBuilder clear(int pos) {
        record.put(pos, null);
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        LogicalTypesGenericRecordBuilder other = (LogicalTypesGenericRecordBuilder) obj;
        if (record == null) {
