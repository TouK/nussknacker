...
import pl.touk.nussknacker.engine.avro.schemaregistry.confluent.client.{AvroSchemaWithJsonPayload, ConfluentSchemaRegistryClient, SwaggerJsonSchema}
...
object JsonSchemaSupport extends ParsedSchemaSupport[SwaggerJsonSchema] {
