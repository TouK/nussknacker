...
/**
  ...
  * @param logic Implements real variable context transformation which was defined in definition
  ...
  */
case class ContextTransformation(definition: ContextTransformationDef, logic: Any)
    extends AbstractContextTransformation {
  override type ContextTransformationDefType = ContextTransformationDef
}

case class JoinContextTransformation(definition: JoinContextTransformationDef, logic: Any)
    extends AbstractContextTransformation {
...
object ContextTransformation {
  ...
  class DefinedByBuilder(definition: ContextTransformationDef) {
    def withLogic(logic: Any): ContextTransformation =
  ...
  class JoinDefinedByBuilder(definition: JoinContextTransformationDef) {
    def withLogic(logic: Any): JoinContextTransformation =
