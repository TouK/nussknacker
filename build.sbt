...
def flinkLibScalaDeps(scalaVersion: String, configurations: Option[String] = None) = forScalaVersion(scalaVersion, Seq(),
  ...
  (2, 13) -> Seq("pl.touk" %% "flink-scala-2-13" % "0.0.1-SNAPSHOT") // our tiny custom module with scala 2.13 `org.apache.flink.runtime.types.FlinkScalaKryoInstantiator` impl
