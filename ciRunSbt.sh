...
echo "Executing: sbt -J-Xss6M -J-Xms2g -J-Xmx2g -J-XX:ReservedCodeCacheSize=256M -J-XX:MaxMetaspaceSize=3g $ARGS"
sbt -J-Xss6M -J-Xms2g -J-Xmx2g -J-XX:ReservedCodeCacheSize=256M -J-XX:MaxMetaspaceSize=3g $ARGS
