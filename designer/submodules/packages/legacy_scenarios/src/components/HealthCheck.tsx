...
import { ReactComponent as TipsWarningIcon } from "../assets/img/tipsWarning.svg";
import { ReactComponent as CollapseIcon } from "../assets/img/panel-hide-arrow.svg";
...
import { HealthCheckResponse, HealthState } from "nussknackerUi/HttpService";
...
function HealthCheck(): JSX.Element {
    ...
    const updateState = useCallback(async () => {
        setState(await api.fetchHealthCheckProcessDeployment());
    }, [api]);
