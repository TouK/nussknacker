...
import { SCENARIOS_FILTER, ScenariosFiltersModelType } from "./scenariosFiltersModel";
import { SimpleOptionsStack } from "./simpleOptionsStack";
import { SortOptionsStack } from "./sortOptionsStack";
import { StatusOptionsStack, TypeOptionsStack } from "./typeOptionsStack";
        ...
        <>
            ...
            >
                ...
                {withCategoriesVisible && (
                    <FilterMenu label={t("table.filter.CATEGORY", "Category")} count={getFilter(SCENARIOS_FILTER.CATEGORY, true).length}>
                        <SimpleOptionsStack
