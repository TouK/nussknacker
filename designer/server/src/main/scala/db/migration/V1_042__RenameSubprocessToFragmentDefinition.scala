...
trait V1_042__RenameSubprocessToFragmentDefinition extends ProcessJsonMigration {

  override def updateProcessJson(jsonProcess: Json): Option[Json] =
    V1_042__RenameSubprocessToFragmentDefinition.updateProcessJson(jsonProcess)

}

object V1_042__RenameSubprocessToFragmentDefinition {
