...
object ScenarioWithDetailsConversions {
  ...
  def fromEntity(
    ...
    fromEntityIgnoringGraphAndValidationResult(entity, processingTypeDetails).withScenarioGraphAndValidationResult(
      entity.json
    )
  ...
  def fromEntityIgnoringGraphAndValidationResult(
    ...
    ScenarioWithDetails(
      ...
      state = None,
      processingMode = processingTypeDetails.processingMode,
      engineSetupName = processingTypeDetails.engineSetupName
    )
  }
