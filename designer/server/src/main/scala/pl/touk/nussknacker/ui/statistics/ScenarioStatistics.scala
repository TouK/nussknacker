...
object ComponentKeys {
  case object Aggregate                         extends StatisticKey("c_ggrgt")
  case object AggregateTumbling                 extends StatisticKey("c_ggrgttmblng")
  case object ListReturnObjectService           extends StatisticKey("c_lstrtrnbjctsrvc")
  case object ComponentService                  extends StatisticKey("c_cmpnntsrvc")
  case object ClassInstanceSource               extends StatisticKey("c_clssnstncsrc")
  case object DatesTypesService                 extends StatisticKey("c_dtstypssrvc")
  case object EchoEnumService                   extends StatisticKey("c_chnmsrvc")
  case object AccountService                    extends StatisticKey("c_ccntsrvc")
  case object DynamicService                    extends StatisticKey("c_dynmcsrvc")
  case object OptionalTypesService              extends StatisticKey("c_ptnltypssrvc")
  case object Monitor                           extends StatisticKey("c_mntr")
  case object AggregateSliding                  extends StatisticKey("c_ggrgtsldng")
  case object HideVariables                     extends StatisticKey("c_hdvrbls")
  case object SingleSideJoin                    extends StatisticKey("c_snglsdjn")
  case object Delay                             extends StatisticKey("c_dly")
  case object Choice                            extends StatisticKey("c_chc")
  case object Request                           extends StatisticKey("c_rqst")
  case object DeadEnd                           extends StatisticKey("c_ddnd")
  case object EnricherNullResult                extends StatisticKey("c_nrchrnllrslt")
  case object MultipleParamsService             extends StatisticKey("c_mltplprmssrvc")
  case object UnionWithEditors                  extends StatisticKey("c_nnwthdtrs")
  case object DecisionTable                     extends StatisticKey("c_dcsntbl")
  case object RealKafkaJsonSampleProduct        extends StatisticKey("c_rlkfkjsnsmplprdct")
  case object Union                             extends StatisticKey("c_nn")
  case object DbQuery                           extends StatisticKey("c_dbqry")
  case object KafkaTransaction                  extends StatisticKey("c_kfktrnsctn")
  case object ParamService                      extends StatisticKey("c_prmsrvc")
  case object RealKafka                         extends StatisticKey("c_rlkfk")
  case object ModelConfigReader                 extends StatisticKey("c_mdlcnfgrdr")
  case object OneSource                         extends StatisticKey("c_nsrc")
  case object Variable                          extends StatisticKey("c_vrbl")
  case object ConstantStateTransformer          extends StatisticKey("c_cnstntstttrnsfrmr")
  case object LastVariableWithFilter            extends StatisticKey("c_lstvrblwthfltr")
  case object Stateful                          extends StatisticKey("c_sttfl")
  case object EnrichWithAdditionalData          extends StatisticKey("c_nrchwthddtnldt")
  case object SendCommunication                 extends StatisticKey("c_sndcmmnctn")
  case object ClientHttpService                 extends StatisticKey("c_clnthttpsrvc")
  case object FullOuterJoin                     extends StatisticKey("c_flltrjn")
  case object PreviousValue                     extends StatisticKey("c_prvsvl")
  case object DbLookup                          extends StatisticKey("c_dblkp")
  case object ConfiguratorService               extends StatisticKey("c_cnfgrtrsrvc")
  case object CommunicationSource               extends StatisticKey("c_cmmnctnsrc")
  case object Kafka                             extends StatisticKey("c_kfk")
  case object Response                          extends StatisticKey("c_rspns")
  case object ServiceModelService               extends StatisticKey("c_srvcmdlsrvc")
  case object ProvidedComponentComponentV1      extends StatisticKey("c_prvddcmpnntcmpnntv1")
  case object SimpleTypesCustomNode             extends StatisticKey("c_smpltypscstmnd")
  case object DeadEndLite                       extends StatisticKey("c_ddndlt")
  case object CollectionTypesService            extends StatisticKey("c_cllctntypssrvc")
  case object UnionReturnObjectService          extends StatisticKey("c_nnrtrnbjctsrvc")
  case object CampaignService                   extends StatisticKey("c_cmpgnsrvc")
  case object ProvidedComponentComponentV2      extends StatisticKey("c_prvddcmpnntcmpnntv2")
  case object BoundedSource                     extends StatisticKey("c_bnddsrc")
  case object Periodic                          extends StatisticKey("c_prdc")
  case object AdditionalVariable                extends StatisticKey("c_ddtnlvrbl")
  case object CommunicationSink                 extends StatisticKey("c_cmmnctnsnk")
  case object CsvSourceLite                     extends StatisticKey("c_csvsrclt")
  case object AggregateSession                  extends StatisticKey("c_ggrgtsssn")
  case object CsvSource                         extends StatisticKey("c_csvsrc")
  case object ServiceWithDictParameterEditor    extends StatisticKey("c_srvcwthdctprmtrdtr")
  case object Collect                           extends StatisticKey("c_cllct")
  case object CustomValidatedService            extends StatisticKey("c_cstmvldtdsrvc")
  case object ComplexReturnObjectService        extends StatisticKey("c_cmplxrtrnbjctsrvc")
  case object ProvidedComponentComponentV3      extends StatisticKey("c_prvddcmpnntcmpnntv3")
  case object KafkaString                       extends StatisticKey("c_kfkstrng")
  case object ForEach                           extends StatisticKey("c_frch")
  case object Split                             extends StatisticKey("c_splt")
  case object Enricher                          extends StatisticKey("c_nrchr")
  case object ConstantStateTransformerLongValue extends StatisticKey("c_cnstntstttrnsfrmrlngvl")
  case object Filter                            extends StatisticKey("c_fltr")
  case object SimpleTypesService                extends StatisticKey("c_smpltypssrvc")
  case object GenericSourceWithCustomVariables  extends StatisticKey("c_gnrcsrcwthcstmvrbls")
  case object SendSms                           extends StatisticKey("c_sndsms")
  case object UnionMemo                         extends StatisticKey("c_nnmm")
  case object CustomFilter                      extends StatisticKey("c_cstmfltr")
  case object SqlSource                         extends StatisticKey("c_sqlsrc")
  case object Log                               extends StatisticKey("c_lg")
  case object DynamicMultipleParamsService      extends StatisticKey("c_dynmcmltplprmssrvc")
  case object NoneReturnTypeTransformer         extends StatisticKey("c_nnrtrntyptrnsfrmr")
  case object Table                             extends StatisticKey("c_tbl")
  case object RecordVariable                    extends StatisticKey("c_rcrdvrbl")
  case object MeetingService                    extends StatisticKey("c_mtngsrvc")
  case object TransactionService                extends StatisticKey("c_trnsctnsrvc")
  case object Custom                            extends StatisticKey("c_cstm")
}
