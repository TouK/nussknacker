...
ALTER TABLE "process_deployment_info" ADD "deployment_action" VARCHAR2(256);
...
ALTER TABLE "process_deployment_info" DROP PRIMARY KEY;

ALTER TABLE "process_deployment_info" ALTER COLUMN "process_version_id" set null;
