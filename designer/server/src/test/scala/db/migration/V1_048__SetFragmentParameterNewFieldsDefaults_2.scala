...
class V1_048__SetFragmentParameterNewFieldsDefaults_2 extends AnyFunSuite with Matchers {
  ...
  test("set absent fragment parameter fields to new defaults") {
    V1_048__SetFragmentParameterNewFieldsDefaultsDefinition_2.updateProcessJson(oldFragment) shouldBe Some(newFragment)
  }
