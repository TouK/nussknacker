  ...
  test("API enum compatibility test") {
    val data = Table(
      ...
      (
        "StatisticName",
        Set(
          "SEARCH_SCENARIO_BY_NAME",
          "SEARCH_SCENARIO_BY_STATUS",
          "SEARCH_SCENARIO_BY_PROCESSING_MODE",
          "SEARCH_SCENARIO_BY_CATEGORY",
          "SEARCH_SCENARIO_BY_AUTHOR",
          "SEARCH_SCENARIO_BY_OTHER",
          "SEARCH_SCENARIO_WITH_SORT",
          "SEARCH_COMPONENTS_BY_NAME",
          "SEARCH_COMPONENTS_BY_GROUP",
          "SEARCH_COMPONENTS_BY_PROCESSING_MODE",
          "SEARCH_COMPONENTS_BY_CATEGORY",
          "SEARCH_COMPONENTS_BY_MULTIPLE_CATEGORIES",
          "SEARCH_COMPONENTS_BY_USAGES",
          "CLICK_COMPONENT_USAGES",
          "SEARCH_COMPONENT_USAGES_BY_NAME",
          "SEARCH_COMPONENT_USAGES_BY_STATUS",
          "SEARCH_COMPONENT_USAGES_BY_CATEGORY",
          "SEARCH_COMPONENT_USAGES_BY_AUTHOR",
          "SEARCH_COMPONENT_USAGES_BY_OTHER",
