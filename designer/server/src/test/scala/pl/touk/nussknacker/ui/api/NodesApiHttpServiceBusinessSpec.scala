...
class NodesApiHttpServiceBusinessSpec
  ...
  "The endpoint for nodes validation should" - {
    ...
    "validate enricher node with a valid test case" in {
      given()
        .applicationState {
          createSavedScenario(exampleScenario)
        }
        ...
        .jsonBody(s"""{
             ...
             |          "expression": {
             |            "language": "spel",
             |            "expression": "#TESTS.assertEquals(#contexts.size, 3)"
             |          }
             |        }
             |      ]
             |    }
    ...
    "validate enricher node with invalid mock expression in a test case" in {
      given()
        .applicationState {
          createSavedScenario(exampleScenario)
        }
        ...
        .equalsJsonBody("""{
            ...
            |        {
            |          "typ": "ExpressionParserCompilationError",
            |          "message": "Cannot find terminating ' for string",
    ...
    "validate node with invalid assertion expression in a test case" in {
      given()
        .applicationState {
          createSavedScenario(exampleScenario)
        }
    ...
    "validate enricher node with wrong mock type in a test case" in {
      given()
        .applicationState {
          createSavedScenario(exampleScenario)
        }
        ...
        .equalsJsonBody("""{
            ...
            |        {
            |          "typ": "ExpressionParserCompilationError",
            |          "message": "Bad expression type, expected: String, found: Integer(123)",
            |          "description": "There is problem with expression in field [mockExpression] - it could not be parsed.",
            |          "details": null
            |        }
            |      ],
