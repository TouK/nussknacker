      ...
      "authenticated should" - {
        "return additional info for node with expression in existing process" in {
          ...
          given()
            ...
            .when()
            .post(s"$nuDesignerHttpAddress/api/nodess/${process.name}/additionalInfo")
            .Then()
            .statusCode(200)
            .equalsJsonBody(
              s"""{
        ...
        "return 404 for not existent process" in {
          ...
          given()
            ...
            .when()
            .post(s"$nuDesignerHttpAddress/api/nodess/$wrongName/additionalInfo")
            .Then()
            .statusCode(404)
            .body(
      ...
      "authenticated should" - {
        "return additional info for process properties" in {
          ...
          given()
            ...
            .when()
            .post(s"$nuDesignerHttpAddress/api/propertiess/${process.name}/additionalInfo")
            .Then()
            .statusCode(200)
            .equalsJsonBody(
              s"""{
      ...
      "authenticated should" - {
        "suggest the name of parameter" in {
          given()
            ...
            .when()
            .post(s"$nuDesignerHttpAddress/api/parameterss/streaming/suggestions")
            .Then()
            .statusCode(200)
