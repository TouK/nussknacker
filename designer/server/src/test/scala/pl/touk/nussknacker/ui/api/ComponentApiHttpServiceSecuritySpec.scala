...
class ComponentApiHttpServiceSecuritySpec
  ...
  private lazy val expectedComponentIdsForLimitedUser: List[String] = List(
    ...
    "streaming1-custom-aggregate-session",
    "streaming1-custom-aggregate-sliding",
    "streaming1-custom-aggregate-tumbling",
    ...
    "streaming1-custom-full-outer-join",
    ...
    "streaming1-custom-single-side-join",
    "streaming1-custom-stateful",
    "streaming1-custom-union-memo",
    ...
    "streaming1-source-event-generator",
    "streaming1-source-eventgeneratorsource",
  ...
  private lazy val expectedComponentIdsForLimitedAnonymousUser: List[String] = List(
    ...
    "streaming2-custom-aggregate-session",
    "streaming2-custom-aggregate-sliding",
    "streaming2-custom-aggregate-tumbling",
    ...
    "streaming2-custom-full-outer-join",
    ...
    "streaming2-custom-single-side-join",
    "streaming2-custom-stateful",
    "streaming2-custom-union-memo",
    ...
    "streaming2-source-event-generator",
    "streaming2-source-eventgeneratorsource",
