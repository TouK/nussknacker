...
class ComponentApiHttpServiceSecuritySpec
  ...
  private lazy val expectedComponentIdsForLimitedUser: List[String] = List(
    ...
    "streaming1-custom-nonereturntypeendingtransformer",
    "streaming1-custom-nonereturntypetransformer",
    "streaming1-custom-timestampreader",
    "streaming1-source-kafka-transaction-no-test-timestamp-assigner",
    ...
    "streaming1-service-hiddenparamtypeservice",
    ...
    "streaming1-service-multipleselecteditorservice",
  ...
  private lazy val expectedComponentIdsForLimitedAnonymousUser: List[String] = List(
    ...
    "streaming2-custom-nonereturntypeendingtransformer",
    "streaming2-custom-nonereturntypetransformer",
    "streaming2-custom-timestampreader",
    "streaming2-source-kafka-transaction-no-test-timestamp-assigner",
