...
import { RUN_ALL, useScenarioTestPresets } from "../src/components/toolbars/test/buttons/scenarioTestButtonContent/useScenarioTestPresets";

jest.mock("../src/assets/img/toolbarButtons/test.svg", () => () => null);
