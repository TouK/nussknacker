...
const typesInformation: ClassDefinition[] = [
    {
        ...
        methods: {
            fooString: { refClazz: { refClazzName: "java.lang.String", display: "String" } },
            barB: { refClazz: { refClazzName: "org.B", display: "B" } },
        },
    },
    {
    ...
    },
    {
        ...
        methods: {
            fooString: { refClazz: { refClazzName: "java.lang.String", display: "String" } },
            barB: { refClazz: { refClazzName: "org.C", display: "C" } },
        },
    },
    {
        clazzName: { refClazzName: "org.WithList", type: "", display: "WithList", fields: {}, params: [] },
        methods: {
            listField: { refClazz: { refClazzName: "java.util.List", display: "List", params: [{ refClazzName: "org.A", display: "A" }] } },
        },
    },
    {
    ...
    },
    {
        ...
        methods: {
            isBefore: {
                refClazz: { refClazzName: "java.lang.Boolean", display: "Boolean" },
...
const variables = {
    ...
    dynamicMap: {
        ...
        display: "Map",
        fields: { intField: { refClazzName: "java.lang.Integer", display: "Integer" }, aField: { refClazzName: "org.A", display: "A" } },
    },
...
describe("expression suggester", () => {
    ...
    it("should suggest dict variable methods using indexer syntax", () => {
        let stubbedDictSuggestions = [{ key: "sentence-with-spaces-and-dots", label: "Sentence with spaces and . dots" }];
