...
export interface LabeledTextareaProps
    extends Pick<LabeledInputProps, "value" | "isMarked" | "children" | "showValidation" | "fieldError">,
...
export default function LabeledTextarea(props: LabeledTextareaProps): JSX.Element {
    const { value, className, isMarked, rows = 1, cols = 50, children, showValidation, fieldError, ...passProps } = props;
