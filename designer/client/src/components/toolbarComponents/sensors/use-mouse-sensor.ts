import { noop } from "@hello-pangea/dnd/src/view/use-sensor-marshal/sensors/../../../empty";
...
function isSloppyClickThresholdExceeded(original: Position, current: Position): boolean {
    ...
    const preventForcePressBinding: EventBinding = useMemo(
        () => ({
            ...
            fn: (event: Event) => {
                ...
                const options: DraggableOptions | null = api.findOptionsForDraggable(id);
