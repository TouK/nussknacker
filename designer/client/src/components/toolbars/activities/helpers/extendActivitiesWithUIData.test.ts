...
describe("extendActivitiesWithUIData", () => {
    ...
    it("should preserve ui data", () => {
        const activities: ActivitiesResponse["activities"] = [
            ...
            {
                id: "0a309251-9b98-4712-9d71-d5f51f0dd218",
                user: "admin",
                date: "2024-10-02T07:52:57.294963Z",
                scenarioVersionId: 13,
                comment: {
        ...
        const previousActivities: UIActivity[] = [
            {
                actions: [
                    {
                        displayableName: "Delete",
                ...
                scenarioVersionId: 13,
                type: "COMMENT_ADDED",
                uiGeneratedId: "7a6d10aa-0309-5d4a-b762-c1c7717f78c8",
                uiType: "item",
                user: "admin",
            },
            {
                ...
                scenarioVersionId: 13,
                type: "COMMENT_ADDED",
                uiGeneratedId: "b8f236ff-c284-588b-bd2a-8f3e89d2afb9",
                uiType: "item",
                user: "admin",
            },
        ];
        ...
        const expected = [
            ...
            },
            {
                ...
                scenarioVersionId: 13,
                type: "COMMENT_ADDED",
                uiGeneratedId: "c2393302-ecd1-5fb7-a0ac-8b6e85bb224f",
                uiType: "item",
                user: "admin",
            },
        ];

        expect(extendActivitiesWithUIData(activitiesDataWithMetadata, previousActivities)).toMatchObject(expected);
    });
});
