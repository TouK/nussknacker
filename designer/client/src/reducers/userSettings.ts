...
const getDefaultUserSettings = (): UserSettings => ({
    ...
    "node.showGenerateEndpointButton": getInitialUserFlag("node.showGenerateEndpointButton", true),
    "node.showSendRequestButton": getInitialUserFlag("node.showSendRequestButton", true),
