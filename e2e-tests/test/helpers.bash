...
prepare_deployed_scenario() {
  ...
  scenario_to_update=`echo $scenario_to_import | curl --fail -u admin:admin -F process=@- $DESIGNER_URL/api/processes/import/$NAME | jq .scenarioGraph | (echo '{ "comment": "created by test", "process": '; cat; echo '}')`
