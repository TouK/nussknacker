...
object ScenarioActionName {
  ...
  val RunNow: ScenarioActionName = ScenarioActionName("run now")
  ...
  def serialize(name: ScenarioActionName): String = name match {
    case ScenarioActionName.RunNow => "PERFORM_SINGLE_EXECUTION"
    case other                     => other.value
  }

  def deserialize(str: String): ScenarioActionName = str match {
    case "PERFORM_SINGLE_EXECUTION" => ScenarioActionName.RunNow
