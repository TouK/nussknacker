/**
  * BEFORE ADDING EXCLUDED BLOCKING IN RUNTIME
...
[info] Result "pl.touk.nussknacker.engine.benchmarks.spel.SpelSecurityExcludeListBenchmark.benchmark":
...
[info] SpelSecurityExcludeListBenchmark.benchmark  avgt    8  0.140 ± 0.007  us/op
[success] Total time: 113 s (01:53), completed Aug 20, 2021, 9:40:39 AM
  */

/**
  * AFTER ADDING EXCLUDED BLOCKING IN RUNTIME
[info] # Warmup Iteration   1: 0.118 us/op
...
[info] # Run complete. Total time: 00:01:51
[info] Benchmark                                 Mode  Cnt  Score   Error  Units
[info] SpelSecurityExcludeListBenchmark.benchmark  avgt    8  0.143 ± 0.008  us/op
...
@State(Scope.Thread)
class SpelSecurityExcludeListBenchmark {
