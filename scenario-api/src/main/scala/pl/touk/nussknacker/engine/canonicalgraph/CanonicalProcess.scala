...
import pl.touk.nussknacker.engine.graph.{TestCase, node}
...
//                             tests: List[TestCase] = List.empty // todo: for now put here only to be stored and versioned together with process version
