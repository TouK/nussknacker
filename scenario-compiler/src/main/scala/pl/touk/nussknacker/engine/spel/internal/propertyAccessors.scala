...
object propertyAccessors {
  ...
  def configured(set: ClassDefinitionSet): Seq[PropertyAccessor] = {
    Seq(
   ...
   */
  class NoParamMethodPropertyAccessor(set: ClassDefinitionSet)
  ...
  class PrimitiveOrWrappersPropertyAccessor(set: ClassDefinitionSet)
